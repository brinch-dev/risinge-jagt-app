                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          entries.isNotEmpty
                              ? '${entries.length} arter — ${entries.fold<int>(0, (s, e) => s + e.count)} stk.'
          ...
          if (entries.isNotEmpty)
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text('Total vildt', style: TextStyle(fontSize: 13, color: cs.onSurfaceVariant)),
