...
class JagtTheme {
  ...
  static final light = ThemeData(
    ...
    colorScheme: ColorScheme.light(
      ...
      primaryContainer: const Color(0xFFCCE5CC),
      ...
      surface: _cream,
      onSurface: _bark,
      onSurfaceVariant: const Color(0xFF5C5345),
      surfaceContainerLowest: Colors.white,
      surfaceContainerLow: _cream,
      surfaceContainer: const Color(0xFFF0EBE0),
      surfaceContainerHigh: const Color(0xFFEAE2D4),
    ...
    inputDecorationTheme: InputDecorationTheme(
      border: OutlineInputBorder(
        ...
        borderSide: BorderSide(color: _sandDark),
      ),
